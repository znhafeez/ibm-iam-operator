...
// PolicyController Operand Image Tag
const policyControllerImageTagPostfix = "3.3.1"
...
func (r *ReconcilePolicyController) deploymentForPolicyController(instance *operatorv1alpha1.PolicyController) *appsv1.Deployment {
	...
	image := instance.Spec.ImageRegistry + "/" + instance.Spec.ImageName + ":" + policyControllerImageTagPostfix
	replicas := instance.Spec.Replicas
